...
\figref{fig:3_motifs}A. The probability was computed as
...
(\figref{fig:3_motifs}A) and tuned anisotropic networks
...
(\figref{fig:3_motifs}, \figref{SI-fig:3motif_rel}). This is in good
...
Interestingly motif 4, while generally overrepresented in anisotropic
...
(\figref{SI-fig:3motif_rr5r10}). Taken together the data show that
...
% and induces an overrepresentation in 
