...
anisotropic networks (\figref{fig:two_neuron}A). Is anisotropy in
...
networks (\figref{fig:two_neuron}B). We found that the pairs counts
...
(\figref{fig:4_net_models}G-H). It is thus natural to assume that the
